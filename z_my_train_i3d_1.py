...
def run(init_lr=0.1, max_steps=64e3, mode='rgb', batch_size=b_sz, save_model=''):
    ...
    #optimizer = optim.Adam(i3d.parameters())
    optimizer = optim.AdamW(i3d.parameters())
    #optimizer = optim.Adagrad(i3d.parameters()) NO
            ...
            for data in dataloaders[phase]:
                ...
                if num_iter == num_steps_per_update and phase == 'train':
                    ...
                    if steps % 10 == 0:
                        ...
                        print('{} Tot Loss: {:.4f}'.format(phase, tot_loss / 10) + ' Steps: ' + str(steps))
                        if steps % 1000 == 0:
                            # save model
